	...
	public int getNum() {
	 ...
	 public void setReadcount(int readcount) {
		...
		public String toString() {
			return "BoardVO [num=" + num + ", writer=" + writer + ", email=" + email + ", subject=" + subject
					+ ", pass=" + pass + ", readcount=" + readcount + ", ref=" + ref + ", step=" + step + ", depth="
					+ depth + ", regdate=" + regdate + ", content=" + content + ", ip=" + ip + "]";
		}
